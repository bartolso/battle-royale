...
let deathMessages = [
    ...
    "rompiendo su cráneo con una piedra",
    "con un arco improvisado",
    "con un hacha de piedra",
    "con una lanza",
    "con un palo",
    "ahogándole",
    "sacándole los ojos con los pulgares",
    "mientras dormía",
    "ahogándole en un río",
    "envenenándole",
    "de un puñetazo",
    "con un cuchillo",
    "pisándole la cabeza",
    "golpeándole con un pescado",
    "ahorcándole",
    "y ha empalado su cadáver",
    "mutilándole",
    "decapitándole",
    "tirándole desde un precipicio",
    "rajándole el vientre",
    "rajándole las muñecas",
    "con una trampa",
    "lanzándole cuchillos",
    "con un garrote de piedra",
    "con un garrote de madera",
    "con un hacha de hueso",
    "rajándole el cuello",
    "con una ballesta",
    "con una katana",
    "con una hoz",
    ...
    "con shurikens",
    "con un nunchaku",
    "con una llave de judo",
    "con un puño americano",
    "clavándole las uñas",
    "dándole de comer sus heces",
    "pisándole el cuello",
    "sentándose en su cara",
    "con un pico",
    "quemándole vivo",
    "con un látigo",
    "con un lanzallamas",
    "lanzándole una colmena de abejas",
    "en un duelo al amanecer",
    "matándolo mientras dormía",
    "en la oscuridad de la noche",
    "tras una acalorada discusión",
    "sin querer",
    "y se ha comido su cadáver",
    "de una paliza",
    "lanzándole una rana venenosa",
    "rompiendo su caja torácica a pedrazos",
    "después de cometer actos pecaminosos",
    "de aburrimiento",
    "enterrándolo vivo"
];
